            ...
            <div class="form-post-real-estate" >
                <form action="MainController" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-element">
                        <label>1. Nhập số Xu
                            <span style="font-size: 14px; color: red; margin-top: 5px;" >Lưu ý : 1 Xu = 1.000.000VNĐ</span>
                        </label>
                        <input type="text" class="form-control" id="soTien" name="soTien" placeholder="Xu" oninput="updateMoney(this.value)" required>
                        <span id="moneyMessage" style="font-size: 14px; color: red; margin-top: 5px;"></span>
                    </div>
                    <div class="form-element">
                        <label>2. Nội dung chuyển khoản</label>
                        <div class="square-box">
                            <h3 style="text-align: center">"TÊN TÀI KHOẢN"_ORDER_"SỐ TIỀN NẠP"</h3>
                        </div>

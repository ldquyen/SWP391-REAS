...
<html>
    ...
    <body>
        ...
        <div style="position: relative">
            ...
            <div class="forgot-password-form padding-bottom-3x mb-2 mt-5">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        <div class="forgot">
                            <h2 style="margin-left: 10px">Forgot your password?</h2>
                            <p style="margin-left: 10px">Change your password in three easy steps. This will help you
                                to secure your password!</p>
                            <ol class="list-unstyled" style="margin-left: 10px">
                        ...
                        <form class="card mt-4 forgot" action="MainController" method="POST">

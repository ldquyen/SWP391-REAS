...
max-width: 50px;
    ...
    <body>
        ...
        <div style="position: relative">
            ...
            <div class="otp-form">
                <div class="row">
                    <div class="col-md-3 col-md-offset-4 otp-container">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="text-center">
                                    ...
                                    <h2 class="text-center" style="color: white">Enter OTP</h2>
                                    <%
                                        String email = (String) session.getAttribute("email");
                                        if (email != null) {
                                            out.print("<p class='texmessaget-info ml-1'> We sent an OTP code to " + email + "</p>");
                                        }
                                    %>
    ...
    <footer class="footer">
        <div>
            ...
            <div class="footer-container">
                ...
                <img class="footer-right-content" src="image/bocongthuong.png" alt="" href="" width="100"
                     height="28" />
            </div>
        </div>
    </footer>

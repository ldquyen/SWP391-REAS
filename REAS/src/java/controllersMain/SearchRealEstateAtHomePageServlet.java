 ...
 * @author ASUS
 */
public class SearchRealEstateAtHomePageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SearchRealEstateAtHomePageServlet.class.getName()).log(Level.SEVERE, null, ex);

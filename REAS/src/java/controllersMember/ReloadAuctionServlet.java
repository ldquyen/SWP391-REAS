 ...
 * @author tranl
 */
@WebServlet(name = "ReloadAuctionServlet", urlPatterns = {"/ReloadAuctionServlet"})
public class ReloadAuctionServlet extends HttpServlet {
...
//            System.out.println(listImgAuction);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ReloadAuctionServlet.class.getName()).log(Level.SEVERE, null, ex);

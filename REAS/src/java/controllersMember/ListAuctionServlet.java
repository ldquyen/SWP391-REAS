 ...
 * @author tranl
 */
@WebServlet(name = "ListAuctionServlet", urlPatterns = {"/ListAuctionServlet"})
public class ListAuctionServlet extends HttpServlet {
     ...
     */
    private final String AUCTIONPAGE = "auctionList.jsp";

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = AUCTIONPAGE;
        try {
            ...
            String sql = "SELECT [RealEstateID], [ImageFolderID], [AccID], [CatID], [CityID], [RealEstateName], [PriceFirst], [TimeUp], [TimeDown], [PriceLast], [Status], [Area], [Address], [Status] ,[Detail] \n"

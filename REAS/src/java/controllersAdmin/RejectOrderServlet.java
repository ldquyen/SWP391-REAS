...
public class RejectOrderServlet extends HttpServlet {
     ...
     */
        ...
        String url = "admin_RejectOrder.jsp";
        String searchValue = request.getParameter("txtSearchValue");
        try {
            if (searchValue == null || searchValue.trim().isEmpty()) {
                WalletDAO dao = new WalletDAO();
                List<OrderWallet> listOrder = dao.getRequestNapTien(3);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
               try {
                   ...
                   Logger.getLogger(RejectOrderServlet.class.getName()).log(Level.SEVERE, null, ex);
               } catch (SQLException ex) {
                   Logger.getLogger(RejectOrderServlet.class.getName()).log(Level.SEVERE, null, ex);
               }
    }

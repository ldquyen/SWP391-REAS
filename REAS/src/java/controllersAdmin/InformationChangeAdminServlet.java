 ...
 * @author TRUONG SON
 */
public class InformationChangeAdminServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (fullname.length() > 1) {
                if (!acc.containsOnlyLettersAndSpaces(fullname)) {
                    ...
                    request.getRequestDispatcher("AdminController?action=adminInformationPage").forward(request, response);
                } else {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(InformationChangeAdminServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
